...
- `brokk-api-design` — for designing the API contract before implementation
- `brokk-database-development` — for data access and persistence logic
- `brokk-devops` — for deploying and operating the backend services
- `brokk-testing` — for writing tests for the backend
