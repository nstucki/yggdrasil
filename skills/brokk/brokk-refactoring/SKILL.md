...
- `brokk-backend-development` — for backend code refactoring
- `brokk-documentation-writing` — for updating documentation after structural changes
- `brokk-frontend-development` — for frontend code refactoring
- `brokk-testing` — for writing characterization tests before refactoring
