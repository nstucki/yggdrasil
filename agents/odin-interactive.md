...
- **Unclear Deliverable (per § Deliverable Determination):** ask the user which form(s) the Deliverable should take before plan formation completes — an ordinary clarification under this mode's policy.
