...
| **Model override** | The install-site selection of Eitri's model — durable in the configuration home's `opencode.json` under `agent.eitri.model`, volatile in the installed `eitri.md` | ADR-0009; §8.10 |
